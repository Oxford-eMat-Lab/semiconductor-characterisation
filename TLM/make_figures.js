 ...
 * ===================================================================== */
{
  ...
  label(s, "Simpler: run this in the TLM folder \u2014 it renders every slide\nand copies the JPEGs to both places for you:",
  ...
  mono("TLM/figures/<name>.jpg", 5.27, 1.88, 4.1, { bold: true });
  ...
  row(0, "Slide 1", "fig_tlm_resistance_chain.jpg");
  row(1, "Slide 2", "fig_tlm_structure.jpg");
  row(2, "Slide 3", "fig_tlm_crowding.jpg");
  row(3, "Slide 4", "fig_tlm_plot.jpg");
  row(4, "Slide 5", "fig_tlm_measurement.jpg");

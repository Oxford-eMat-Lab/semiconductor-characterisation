#!/usr/bin/env bash
# Renders figures.pptx to the JPEG files used by cgv_analysis.ipynb and the
...
NAMES=(
  fig_cgv_mos_structure
  fig_cgv_equivalent_circuit
  fig_cgv_curve_shapes
  fig_cgv_doping_profile
  fig_cgv_conductance_method
)
